...
export default function TestsPage() {
  ...
  function importFromSet(set: QuestionSet) {
    ...
    const imported: Question[] = set.questions.map((aq) => {
      const type = (
        aq.type === "extended_response" ? "short_answer" : aq.type
      ) as QuestionType;
      const base = {
        id: crypto.randomUUID(),
        type,
            ...
            <div className="p-6 space-y-4">
              <div className="bg-gray-50 rounded-lg p-4 text-sm space-y-1">
                ...
                <p>
                  ...
                  {reviewModal.percentage}% ({reviewModal.score}/
                  {reviewModal.totalPoints} pts)
                </p>
                <p>
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    value={form.passMark}
                    onChange={(e) =>
                      setForm({ ...form, passMark: Number(e.target.value) })
                    }
                    className="admin-input"
                  />
                </div>
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-400 mt-1">
                    Students must complete this material before the test
                    unlocks.
                  </p>
                </div>
                <div className="sm:col-span-2">
                ...
                <div className="flex items-center justify-between mb-3">
                  <h3 className="font-semibold text-gray-800">
                    ...
                    <span className="text-gray-400 font-normal text-sm">
                      ({form.questions.length} · {calcTotal(form.questions)} pts
                      total)
                    </span>
                  </h3>
                        ...
                        {q.type === "true_false" && (
                          <div>
                            ...
                            <select
                              ...
                              onChange={(e) =>
                                updateQ(idx, { correctAnswer: e.target.value })
                              }
                        ...
                        {q.type === "short_answer" && (
                          <div>
                            ...
                            <input
                              ...
                              className="admin-input"
                              placeholder="Key term the answer must contain…"
                            />
                            <p className="text-xs text-gray-400 mt-1">
                              Student answer is correct if it contains this
                              text.
                            </p>
                          </div>
                        )}
                        <div className="grid grid-cols-2 gap-3">
                          <div>
                            ...
                            <input
                              ...
                              value={q.points}
                              onChange={(e) =>
                                updateQ(idx, { points: Number(e.target.value) })
                              }
                              className="admin-input"
                            />
                          </div>
                          <div>
                            ...
                            <input
                              value={q.explanation ?? ""}
                              onChange={(e) =>
                                updateQ(idx, { explanation: e.target.value })
                              }
                              className="admin-input"
